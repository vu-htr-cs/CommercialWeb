...
<div class="container-fluid">
        ...
        <div class="row info-content">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 col_left">
                <ul class="nav flex-column nav-pills" role="tablist">
                    ...
                    <li class="nav-item" >
                      <a class="nav-link" id='tab3' data-toggle="pill" href="#menu2">Quản lý người dùng</a>
                    </li>
          ...
          <input type="submit" value="Đổi hình" class="btn btn-sm btn-primary"  >
                    ...
                    <div id="menu2" class="tab-pane fade" style="color:white;">
                        ...
                        <?php if($msg=="done"){echo " <center> <p id='needclear2' style='color:#00FF66'>Thành Công! <p> </center>" ; }  ?>
                      
                      <br>
                      <div class="menu2-body">
                            
                                <div class="row input-id-row">
                                <form method="POST" action="index.php?controller=account&action=viewmsgadmin&chimuc=20" class="ineedf">
                                    <div class="col-9 col-lg-9 col-md-9 col-sm-9 col-xl-9 col-xs-9">
                                    <input class="form-control" id = "sbook" type="text" placeholder="Nhập id người dùng..." name="idnd">
                                    </div>
                                ...
                                <div class="row">
                                    <form action="index.php?controller=account&action=updatequyen" method="POST">
                                    <table class="role">
                                        <thead>
                                            <th colspan="5" id="role-main-title">DANH SÁCH NGƯỜI SỬ DỤNG</th>
                                        </thead>
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <input type="text" name='quyencua[<?= $user['id_nguoidung'] ?>]' value="<?= $user['quyenid']?>" style="text-align:center" class="soluonghang"> 
                                                
                                            </td>
                                            <th> <a href="index.php?controller=account&action=removeuser&id=<?=$user['id_nguoidung']?>&tendangnhap=<?= $user['tendangnhap'] ?>">
                                                <i style="color:red" class="fas fa-times"></i> </a>
                                            </th>
                                        </tr>
                                    ...
                                    <input type="submit" class="btn btn-primary sayno" value="Cập nhập"> </form>
                                </div>
    ...
    <?php if($chimuc==13): ?>
           <script> 
            ...
            <?php elseif($chimuc==20):?>

                <script> 
                    const chi1=document.querySelector('#tab1');
                    const chi2=document.querySelector('#tab2');
                    const chi3=document.querySelector('#tab3');

                    const tabcontent2=document.querySelector('#menu2');
                             
                    const home=document.querySelector('#home');
                   
                    const needclear=document.querySelector('#needclear');
                    const needclear2=document.querySelector('#needclear2');
                    
                    chi2.classList.remove('active');
                    chi1.classList.remove('active');
                    chi3.classList.add('active');
                    ...
                    setTimeout(()=>{
                       needclear.parentElement.removeChild(needclear);
                       needclear2.parentElement.removeChild(needclear2);
